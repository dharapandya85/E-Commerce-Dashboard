...
export async function emailOrderHistory(prevState:unknown,
    ...
    if(user==null){
        ...
        const orders= user.orders.map(async (order: { priceInCents: number; id: string; createdAt: Date; product: { id: string; name: string; imagePath: string; description: string; }; }) => {
            return{
                ...order,
                pricePaidInCents: order.priceInCents,
